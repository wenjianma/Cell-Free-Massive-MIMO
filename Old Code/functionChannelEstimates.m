...
% This function generate channel estimation for cell free massive MIMO
% using MMSE estimator and also we assumed pilot are orthogonal to each other
...
for ap = 1:numAPs
    ...
    for tk = 1:numOPilots
        ...
        iMat = (power*numOPilots*sum(cMat(:,:,pilotIndex == tk,ap),3) + identityMatrix); % question: why not sigma^2 (variance^2) but only identity matrix ans: because it is normalize, so sigma^2 = 1 
