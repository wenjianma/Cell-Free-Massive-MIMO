...
%% Begin Code
function [R,bklT,pilotIndex] = generalsetup(K, L, N,pilotLength,flag)
...
for current_UE = 1:K
        ...
        distances(:,current_UE) = sqrt((h_bs-h_ue)^2+distancetoUE.^2);
       ...
       % whichpos_tot(:,current_UE) = whichpos; 
        ...
        for current_AP = 1:L
            Runcorr(:,:,current_AP,current_UE) = channel_gainOverNoise(current_AP,current_UE)*eye(N);
        end 
